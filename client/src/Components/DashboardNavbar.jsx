  ...
  return (
    <nav className="bg-white px-5 sm:px-10  sticky top-0 z-30 h-16 flex justify-between py-5 flex-row items-center">
      <div className="hidden flex-col lg:flex">
        ...
        <p className="text-sm text-gray-400">Let's check your Garage today</p>
      </div>
      <div className="flex lg:hidden flex-row justify-between w-full mr-5">
        ...
        <Link to="" className="rounded-full">
          <i class="fa-solid fa-table-columns text-black"></i>
        </Link>
        ...
        <Link to="" className="rounded-full">
          <i class="fa-solid fa-arrow-right-from-bracket text-black "></i>
        </Link>
      ...
      <div className="flex flex-row items-center gap-2 ml-2">
        <img src="/pfp.jpg" alt="" className="rounded-full size-12" />
        <div className="hidden sm:flex flex-col  gap-1 ">
          <h1 className="text-base text-black">Test</h1>
