    ...
    <aside className="w-64 bg-black  hidden lg:flex flex-col h-screen sticky top-0 py-10 px-5 gap-20">
      ...
      <div>
        <ul className="text-white text-sm flex gap-5 flex-col">
          ...
          >
            <li className="py-5 w-full px-5 flex flex-row gap-5 items-center rounded-2xl cursor-pointer hover:bg-yellow-300 group transition-colors duration-300 ease-in-out">
              <i class="fa-solid fa-table-columns text-yellow-300 group-hover:text-black transition-colors duration-300 ease-in-out"></i>
              <p className="group-hover:text-black transition-colors duration-300 ease-in-out">
                Dashboard
              </p>
            </li>
          ...
          >
            <li className="py-5 w-full px-5 flex flex-row gap-5 items-center rounded-2xl cursor-pointer hover:bg-yellow-300 group transition-colors duration-300 ease-in-out">
              <i class="fa-solid fa-people-group text-yellow-300 group-hover:text-black transition-colors duration-300 ease-in-out"></i>
              <p className="group-hover:text-black transition-colors duration-300 ease-in-out">
                Customers
              </p>
            </li>
          ...
          >
            <li className="py-5 w-full px-5 flex flex-row gap-5 items-center rounded-2xl cursor-pointer hover:bg-yellow-300 group transition-colors duration-300 ease-in-out">
              <i class="fa-solid fa-calendar-days text-yellow-300 group-hover:text-black transition-colors duration-300 ease-in-out"></i>
              <p className="group-hover:text-black transition-colors duration-300 ease-in-out">
                Bookings
              </p>
            </li>
          ...
          <Link to="/mechanics">
            <li className="py-5 px-5 w-full flex flex-row gap-5 items-center rounded-2xl cursor-pointer hover:bg-yellow-300 group transition-colors duration-300 ease-in-out">
              <i class="fa-solid fa-user-group text-yellow-300 group-hover:text-black transition-colors duration-300 ease-in-out"></i>
              <p className="group-hover:text-black transition-colors duration-300 ease-in-out">
                Staff Management
              </p>
            </li>
        ...
        <Link to="/" className="text-black flex flex-row gap-5 items-center absolute bottom-10 bg-yellow-300 py-5 px-10 cursor-pointer rounded-2xl">
