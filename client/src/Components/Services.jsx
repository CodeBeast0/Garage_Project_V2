  ...
  return (
    <div className="bg-[#1B252F] py-20 px-10 w-[100%] h-[500vh] border-b-[25px] border-b-[#FFDE01]">
      ...
      <div className="mt-10 flex justify-center items-center">
        <NavLink to="/Services">
          <button className="bg-[#FFDE01] py-5 px-5 text-black cursor-pointer text-xl font-bold hover:bg-black hover:text-[#FFDE01] transition-colors">
            View All Services <i className="fa-solid fa-forward ml-3"></i>
          </button>
        </NavLink>
